...
#ifndef RTW_HEADER_system_step_input_h_
#define RTW_HEADER_system_step_input_h_
#ifndef system_step_input_COMMON_INCLUDES_
#define system_step_input_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* system_step_input_COMMON_INCLUDES_ */

#include "system_step_input_types.h"
...
#define system_step_input_rtModel      RT_MODEL_system_step_input_T
...
typedef struct {
  ...
  int32_T HILInitialize_DOStates[8];   /* '<S2>/HIL Initialize' */
...
#define rtB                            system_step_input_B
#define BlockIO                        B_system_step_input_T
#define rtX                            system_step_input_X
#define ContinuousStates               X_system_step_input_T
#define rtXdot                         system_step_input_XDot
#define StateDerivatives               XDot_system_step_input_T
#define tXdis                          system_step_input_XDis
#define StateDisabled                  XDis_system_step_input_T
#define rtP                            system_step_input_P
#define Parameters                     P_system_step_input_T
#define rtDWork                        system_step_input_DW
#define D_Work                         DW_system_step_input_T

/* Parameters (default storage) */
struct P_system_step_input_T_ {
...
struct tag_RTM_system_step_input_T {
  const char_T *path;
...
extern P_system_step_input_T system_step_input_P;

/* Block signals (default storage) */
extern B_system_step_input_T system_step_input_B;

/* Continuous states (default storage) */
extern X_system_step_input_T system_step_input_X;

/* Block states (default storage) */
extern DW_system_step_input_T system_step_input_DW;

/* Model entry point functions */
extern void system_step_input_initialize(void);
extern void system_step_input_output(void);
extern void system_step_input_update(void);
extern void system_step_input_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern system_step_input_rtModel *system_step_input(void);
...
extern RT_MODEL_system_step_input_T *const system_step_input_M;
 ...
 *
 * '<Root>' : 'system_step_input'
 * '<S1>'   : 'system_step_input/C(s)'
 * '<S2>'   : 'system_step_input/SRV02 Flexible Link'
 * '<S3>'   : 'system_step_input/UDP Read1'
 * '<S4>'   : 'system_step_input/SRV02 Flexible Link/Actuator Dynamics'
 * '<S5>'   : 'system_step_input/UDP Read1/UDP Read'
 */
#endif                                 /* RTW_HEADER_system_step_input_h_ */
