###########################################################################
## Makefile generated for component 'system_step_input'. 
## 
## Makefile     : system_step_input.mk
## Generated on : Fri May 08 18:09:02 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\system_step_input.rt-win64
...
PRODUCT_NAME              = system_step_input
MAKEFILE                  = system_step_input.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2023a
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2023a\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\Flexible4\Documents\MATLAB\Ping-Pong-Detection
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = system_step_input_comp.rsp
CMD_FILE                  = system_step_input.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\system_step_input.rt-win64
...
DEFINES_STANDARD = -DMODEL=system_step_input -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\system_step_input_quarc_win64\rtGetInf.c $(START_DIR)\system_step_input_quarc_win64\rtGetNaN.c $(START_DIR)\system_step_input_quarc_win64\rt_nonfinite.c $(START_DIR)\system_step_input_quarc_win64\system_step_input.c $(START_DIR)\system_step_input_quarc_win64\system_step_input_data.c $(START_DIR)\system_step_input_quarc_win64\system_step_input_main.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj system_step_input.obj system_step_input_data.obj system_step_input_main.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\system_step_input_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\system_step_input_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
rtGetInf.obj : "$(START_DIR)\system_step_input_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\system_step_input_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\system_step_input_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\system_step_input_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\system_step_input_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\system_step_input_quarc_win64\rt_nonfinite.c"


system_step_input.obj : "$(START_DIR)\system_step_input_quarc_win64\system_step_input.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\system_step_input_quarc_win64\system_step_input.c"


system_step_input_data.obj : "$(START_DIR)\system_step_input_quarc_win64\system_step_input_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\system_step_input_quarc_win64\system_step_input_data.c"


system_step_input_main.obj : "$(START_DIR)\system_step_input_quarc_win64\system_step_input_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\system_step_input_quarc_win64\system_step_input_main.c"
