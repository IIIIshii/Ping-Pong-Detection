...
% for kk=1:N_for
%     for kkk=1:N_d
%         P(:,(kk-1)*Nd + kkk)=[omega((kk-1)*Nd + kkk);SysGain((kk-1)*Nd + kkk);SysPhase((kk-1)*Nd + kkk)];
%     end
% end
...
filename = ['SKE2026_data',date,'_',clockh,clockmin,'.mat'];
save(filename,'P')
filename = ['SKE2026_data',date,'_',clockh,clockmin,'.dat'];
csvwrite(filename,P)
