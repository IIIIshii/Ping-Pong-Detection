###########################################################################
## Makefile generated for component 'seesaw'. 
## 
## Makefile     : seesaw.mk
## Generated on : Fri May 08 15:56:20 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\seesaw.rt-win64
...
COMPILER_COMMAND_FILE     = seesaw_comp.rsp
CMD_FILE                  = seesaw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\seesaw.rt-win64
...
DEFINES_STANDARD = -DMODEL=seesaw -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\seesaw_quarc_win64\rtGetInf.c $(START_DIR)\seesaw_quarc_win64\rtGetNaN.c $(START_DIR)\seesaw_quarc_win64\rt_nonfinite.c $(START_DIR)\seesaw_quarc_win64\seesaw.c $(START_DIR)\seesaw_quarc_win64\seesaw_main.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj seesaw.obj seesaw_main.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\seesaw_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\seesaw_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
rtGetInf.obj : "$(START_DIR)\seesaw_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\seesaw_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\seesaw_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\seesaw_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\seesaw_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\seesaw_quarc_win64\rt_nonfinite.c"


seesaw.obj : "$(START_DIR)\seesaw_quarc_win64\seesaw.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\seesaw_quarc_win64\seesaw.c"


seesaw_main.obj : "$(START_DIR)\seesaw_quarc_win64\seesaw_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\seesaw_quarc_win64\seesaw_main.c"
