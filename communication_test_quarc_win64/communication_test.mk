###########################################################################
## Makefile generated for component 'communication_test'. 
## 
## Makefile     : communication_test.mk
## Generated on : Fri May 08 16:07:04 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\communication_test.rt-win64
...
PRODUCT_NAME              = communication_test
MAKEFILE                  = communication_test.mk
...
COMPILER_COMMAND_FILE     = communication_test_comp.rsp
CMD_FILE                  = communication_test.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\communication_test.rt-win64
...
DEFINES_STANDARD = -DMODEL=communication_test -DNUMST=2 -DNCSTATES=4 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\communication_test_quarc_win64\communication_test.c $(START_DIR)\communication_test_quarc_win64\communication_test_data.c $(START_DIR)\communication_test_quarc_win64\communication_test_main.c $(START_DIR)\communication_test_quarc_win64\rtGetInf.c $(START_DIR)\communication_test_quarc_win64\rtGetNaN.c $(START_DIR)\communication_test_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = communication_test.obj communication_test_data.obj communication_test_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\communication_test_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\communication_test_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
communication_test.obj : "$(START_DIR)\communication_test_quarc_win64\communication_test.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\communication_test_quarc_win64\communication_test.c"


communication_test_data.obj : "$(START_DIR)\communication_test_quarc_win64\communication_test_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\communication_test_quarc_win64\communication_test_data.c"


communication_test_main.obj : "$(START_DIR)\communication_test_quarc_win64\communication_test_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\communication_test_quarc_win64\communication_test_main.c"


rtGetInf.obj : "$(START_DIR)\communication_test_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\communication_test_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\communication_test_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\communication_test_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\communication_test_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\communication_test_quarc_win64\rt_nonfinite.c"
