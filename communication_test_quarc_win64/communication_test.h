...
#define communication_test_rtModel     RT_MODEL_communication_test_T
...
typedef struct {
  ...
  real_T StrainGageCalibrationradV;
                                  /* '<S2>/Strain Gage Calibration  (rad//V)' */
...
#define rtB                            communication_test_B
#define BlockIO                        B_communication_test_T
#define rtX                            communication_test_X
#define ContinuousStates               X_communication_test_T
#define rtXdot                         communication_test_XDot
#define StateDerivatives               XDot_communication_test_T
#define tXdis                          communication_test_XDis
#define StateDisabled                  XDis_communication_test_T
#define rtP                            communication_test_P
#define Parameters                     P_communication_test_T
#define rtDWork                        communication_test_DW
#define D_Work                         DW_communication_test_T
...
extern void communication_test_output(void);
extern void communication_test_update(void);
extern void communication_test_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern communication_test_rtModel *communication_test(void);
