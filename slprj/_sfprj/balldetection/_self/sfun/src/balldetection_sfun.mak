...
MODEL     = balldetection
TARGET      = sfun
MODULE_SRCS   = c2_balldetection.c half_type.c
MODEL_SRC  = balldetection_sfun.c
MODEL_REG = balldetection_sfun_registry.c
MAKEFILE    = balldetection_sfun.mak
...
USER_INCLUDES   =  /I "C:\Users\flexible4\documents\MATLAB\ping-pong-detection\slprj\_sfprj\balldetection\_self\sfun\src" /I "C:\Users\flexible4\documents\MATLAB\ping-pong-detection"
AUX_INCLUDES   = 
MLSLSF_INCLUDES = \
    ...
    /I "C:\Users\Flexible4\Documents\MATLAB\Ping-Pong-Detection\slprj\_sfprj\balldetection\_self\sfun\src" 
...
OBJLIST_FILE = balldetection_sfun.mol
SFCLIB = 
AUX_LNK_OBJS =     
USER_LIBS = 
#--------------------------------- Rules --------------------------------------
