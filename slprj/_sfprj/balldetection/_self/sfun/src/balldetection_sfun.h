#ifndef __balldetection_sfun_h__
#define __balldetection_sfun_h__
...
extern mxArray* load_balldetection_optimization_info(boolean_T isRtwGen,
  boolean_T isModelRef, boolean_T isExternal);
extern void unload_balldetection_optimization_info(void);
