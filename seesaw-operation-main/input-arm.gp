...
set output filename."_input-arm.png" # ファイル名を設定する。

# 軸ラベルを設定する。
set xlabel 'Time [s]'
set ylabel 'Input Value'
set y2label 'Arm Angle [rad]'
set ytics nomirror
set y2tics nomirror
...
plot filename.".txt" u 1:4 title "Input Value" axis x1y1 pt 1 lc rgb colors7[2] w l,\
     filename.".txt" u 1:3 title "Arm Angle" axis x1y2 pt 1 lc rgb colors7[3] w l
