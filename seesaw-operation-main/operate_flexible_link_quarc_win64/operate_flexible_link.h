...
#ifndef RTW_HEADER_operate_flexible_link_h_
#define RTW_HEADER_operate_flexible_link_h_
#ifndef operate_flexible_link_COMMON_INCLUDES_
#define operate_flexible_link_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                              /* operate_flexible_link_COMMON_INCLUDES_ */
...
#define operate_flexible_link_rtModel  RT_MODEL_operate_flexible_lin_T
...
#define rtB                            operate_flexible_link_B
#define BlockIO                        B_operate_flexible_link_T
#define rtX                            operate_flexible_link_X
#define ContinuousStates               X_operate_flexible_link_T
#define rtXdot                         operate_flexible_link_XDot
#define StateDerivatives               XDot_operate_flexible_link_T
#define tXdis                          operate_flexible_link_XDis
#define StateDisabled                  XDis_operate_flexible_link_T
#define rtP                            operate_flexible_link_P
#define Parameters                     P_operate_flexible_link_T
#define rtDWork                        operate_flexible_link_DW
#define D_Work                         DW_operate_flexible_link_T
...
struct P_operate_flexible_link_T_ {
  ...
  real_T InverseAmplifierGainVV_Gain;  /* Expression: 1
                                        * Referenced by: '<S3>/Inverse Amplifier  Gain (V//V)'
                                        */
  real_T DACBSaturationV_UpperSat;     /* Expression: 10
                                        * Referenced by: '<S3>/DACB Saturation (V)'
                                        */
  ...
  real_T Constant_Value;               /* Expression: 0.6
                                        ...
                                        */
  real_T pos_Value;                    /* Expression: 0.4523096720377604
...
struct tag_RTM_operate_flexible_link_T {
  const char_T *path;
...
extern P_operate_flexible_link_T operate_flexible_link_P;

/* Block signals (default storage) */
extern B_operate_flexible_link_T operate_flexible_link_B;

/* Continuous states (default storage) */
extern X_operate_flexible_link_T operate_flexible_link_X;

/* Block states (default storage) */
extern DW_operate_flexible_link_T operate_flexible_link_DW;

/* Model entry point functions */
extern void operate_flexible_link_initialize(void);
extern void operate_flexible_link_output(void);
extern void operate_flexible_link_update(void);
extern void operate_flexible_link_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern operate_flexible_link_rtModel *operate_flexible_link(void);
...
extern RT_MODEL_operate_flexible_lin_T *const operate_flexible_link_M;
 ...
 * '<S1>'   : 'operate_flexible_link/C(s)'
 * '<S2>'   : 'operate_flexible_link/SRV02 Flexible Link'
 * '<S3>'   : 'operate_flexible_link/SRV02 Flexible Link/Actuator Dynamics'
 */
