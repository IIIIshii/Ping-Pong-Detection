...
## Generated on : Fri May 22 16:34:43 2026
...
PRODUCT_NAME              = operate_flexible_link
MAKEFILE                  = operate_flexible_link.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2023a
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2023a\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\Flexible4\Documents\MATLAB\Ping-Pong-Detection\seesaw-operation-main
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = operate_flexible_link_comp.rsp
CMD_FILE                  = operate_flexible_link.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\operate_flexible_link.rt-win64
...
DEFINES_STANDARD = -DMODEL=operate_flexible_link -DNUMST=2 -DNCSTATES=8 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\operate_flexible_link_quarc_win64\operate_flexible_link.c $(START_DIR)\operate_flexible_link_quarc_win64\operate_flexible_link_data.c $(START_DIR)\operate_flexible_link_quarc_win64\operate_flexible_link_main.c $(START_DIR)\operate_flexible_link_quarc_win64\rtGetInf.c $(START_DIR)\operate_flexible_link_quarc_win64\rtGetNaN.c $(START_DIR)\operate_flexible_link_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = operate_flexible_link.obj operate_flexible_link_data.obj operate_flexible_link_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\operate_flexible_link_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\operate_flexible_link_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
operate_flexible_link.obj : "$(START_DIR)\operate_flexible_link_quarc_win64\operate_flexible_link.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\operate_flexible_link_quarc_win64\operate_flexible_link.c"


operate_flexible_link_data.obj : "$(START_DIR)\operate_flexible_link_quarc_win64\operate_flexible_link_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\operate_flexible_link_quarc_win64\operate_flexible_link_data.c"


operate_flexible_link_main.obj : "$(START_DIR)\operate_flexible_link_quarc_win64\operate_flexible_link_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\operate_flexible_link_quarc_win64\operate_flexible_link_main.c"


rtGetInf.obj : "$(START_DIR)\operate_flexible_link_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\operate_flexible_link_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\operate_flexible_link_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\operate_flexible_link_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\operate_flexible_link_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\operate_flexible_link_quarc_win64\rt_nonfinite.c"
