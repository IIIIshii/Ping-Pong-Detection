...
filename = "result-single"
# filename = "result-double"
# filename = "result-double_I"

set term pngcairo # pngファイルに出力する。
set output filename."-arm.png" # ファイル名を設定する。

# 軸ラベルを設定する。
set xlabel 'Time [s]'
set ylabel 'Arm Angle [rad]'
...
plot for [i = 1:4] filename.sprintf("-%d.txt", i) u 1:3 title sprintf("Experiment-%d", i) pt 1 lc rgb colors7[i] w l
